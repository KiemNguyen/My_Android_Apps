...
public class GameActivity extends ActionBarActivity {
    ...
    public void checkLetter(String introducedLetter) {
        ...
        if (guessLetters == myWord.length()) {
            //Increase the points of guess is correct
            myPoints++;
            //Clear the previous word
            clearScreen();

            //Call the setRandomWord method to get random words
            setRandomWord();
    ...
    public void setRandomWord(){
        ...
        //Put words in an array using split method from String class
        ...
        //Get random word using the position of randomNumber
        String randomWords = arrayWords[randomNumber];
